...
class StartUITest {
    ...
    void whenReplaceItemTestOutputIsSuccessfully() {
        ...
        Input input = new MockInput(
                List.of(new String[]{"0", String.valueOf(one.getId()), replaceName, "1"})
        );
        List<UserAction> actions = new ArrayList<>();
        actions.add(new Replace(output));
        actions.add(new Exit(output));
    ...
    void whenFindByIdItemTestOutputIsSuccessfully() {
        ...
        Item one = tracker.add(new Item("test1"));
        Input input = new MockInput(
                List.of(new String[]{"0", String.valueOf(one.getId()), "1"})
        );
        List<UserAction> actions = new ArrayList<>();
    ...
    void whenFindByNameItemTestOutputIsSuccessfully() {
        ...
        Item one = tracker.add(new Item("test1"));
        Input input = new MockInput(
                List.of(new String[]{"0", one.getName(), "1"})
        );
        List<UserAction> actions = new ArrayList<>();
